...
<div class="head_container">
	<div class="head_welcome">
		...
		<c:if test="${loginUser.email!=null}">[${loginUser.email}&nbsp;<a href="login_form.jsp" class="b">登出</a>&nbsp;]</c:if>
		<c:if test="${loginUser.email==null}">[&nbsp;<a href="" class="b">登出</a>&nbsp;]
		[&nbsp;<a href="${pageContext.request.contextPath}/user/login_form.jsp" class="b">登录</a>|<a
			href="${pageContext.request.contextPath}/user/register_form.jsp" class="b">注册</a>&nbsp;]</c:if>
