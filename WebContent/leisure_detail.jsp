...
<div class="wrapper">
  ...
  <div class="section_container"> 
    ...
    <div id="product_detail"> 
      <!--Product Left Starts-->
      <div class="product_leftcol"> <img src="images/pr_main.jpg" /> <span class="pr_info">ROLL OVER IMAGE TO ZOOM</span>
        <ul class="pr_gallery">
      ...
      <div class="product_rightcol"> <small class="pr_type">Formal Dress</small>
        ...
        <div class="pr_price"> <big>$49.90</big> <small>$72.00</small> </div>
        <div class="size_info">
          <div class="size_sel">
