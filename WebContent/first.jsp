...
<link rel="shortcut icon" type="image/x-icon" href="/images/ico/dang.ico" />
<body>
<div class="wrapper">
    <div class="header_container">
        ...
        <header>
            <div class="top_bar clear">
                ...
                <ul class="top_links">
                    <li style="padding-left:100px; margin:0px; padding:0px;"><a href="#">test</a></li>
                    <li><a href="#">购物车</a></li>
                    <li><a href="#">登录</a></li>
                    <li><a href="#">注册</a></li>
                    <li class="highlight"><a href="#">我的当当</a></li>
                </ul>
                <!--Top Links Ends-->
            </div>
            <!--Logo Starts-->
            <h1 class="logo"> <a href="leisure_index.html"><img src="images/dangdang_logo.png" /></a> </h1>
            <!--Logo Ends-->
    ...
    <div class="navigation_container">
        ...
        <nav>
            <ul class="primary_nav">
                <li class="active"><a href="leisure_listing.jsp"><font size="10">所有种类</font></a>
                    <!--SUbmenu Starts-->
                    <ul class="sub_menu">
                        <li> <a href="#">Dresses</a>
                            <ul>
                ...
                <li><a href="leisure_listing.html">男士</a>
                    <!--SUbmenu Starts-->
                    <ul class="sub_menu">
                ...
                <li><a href="leisure_listing.html">女式</a>
                	<ul class="sub_menu">
                        <li> <a href="#">Men Summer Collection</a>
                            <ul>
                                <li><a href="#">Premium Pants</a></li>
